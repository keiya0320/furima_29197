...
ActiveRecord::Schema.define(version: 2020_09_02_091903) do
  ...
  create_table "order_infos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["product_id"], name: "index_order_infos_on_product_id"
    t.index ["user_id"], name: "index_order_infos_on_user_id"
  end
  ...
  add_foreign_key "order_infos", "products"
  add_foreign_key "order_infos", "users"
